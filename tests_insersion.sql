...
INSERT INTO `mydb`.`integrante` (`integrante_nombre`, `integrantecol_email`, `equipo_id_equipo`) VALUES ('Juan Pérez', 'juan@example.com', equipo_id_equipo);
INSERT INTO `mydb`.`integrante` (`integrante_nombre`, `integrantecol_email`, `equipo_id_equipo`) VALUES ('María Rodríguez', 'maria@example.com', equipo_id_equipo_cancelado);
